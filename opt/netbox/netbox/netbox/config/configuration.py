###
# Adapted from https://github.com/netbox-community/netbox-docker/blob/release/configuration/configuration.py
#
# For reference see https://docs.netbox.dev/en/stable/configuration/
#               and https://github.com/netbox-community/netbox/blob/develop/netbox/netbox/configuration_example.py
####
...
BASE_PATH = environ.get('NETBOX_BASE_PATH', '')
...
DATABASE = {
    ...
    'PASSWORD': _read_secret('postgres_password', environ.get('POSTGRES_PASSWORD', '')),
    'HOST': environ.get('POSTGRES_HOST', 'localhost'),
    'PORT': environ.get('POSTGRES_PORT', ''),
    'OPTIONS': {'sslmode': environ.get('POSTGRES_SSLMODE', 'prefer')},
    'CONN_MAX_AGE': _environ_get_and_map('POSTGRES_CONN_MAX_AGE', '300', _AS_INT),
    'DISABLE_SERVER_SIDE_CURSORS': _environ_get_and_map('POSTGRES_DISABLE_SERVER_SIDE_CURSORS', 'False', _AS_BOOL),
}
